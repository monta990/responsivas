 ...
 * ============================ */
try {
   $result = PluginResponsivasPdfBuilder::buildComputerPdf($user_id);
   Log::history($user_id, 'User', [0, '', ''], 'responsivas: computer PDF downloaded', Log::HISTORY_LOG_SIMPLE_MESSAGE);
