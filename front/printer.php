 ...
 * ============================ */
try {
   $result = PluginResponsivasPdfBuilder::buildPrinterPdf($user_id);
   Log::history($user_id, 'User', [0, '', ''], 'responsivas: printer PDF downloaded', Log::HISTORY_LOG_SIMPLE_MESSAGE);
